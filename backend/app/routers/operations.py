...
def update_qr_menu_settings(
    ...
    cleaned = {
        ...
        "background_color": str(payload.get("background_color") or current.get("background_color") or "#0f0f0f").strip() or "#0f0f0f",
        "surface_color": str(payload.get("surface_color") or current.get("surface_color") or "#1a1a1a").strip() or "#1a1a1a",
        "text_color": str(payload.get("text_color") or current.get("text_color") or "#ffffff").strip() or "#ffffff",
        "primary_color": str(payload.get("primary_color") or current.get("primary_color") or "#facc15").strip() or "#facc15",
        "accent_color": str(payload.get("accent_color") or current.get("accent_color") or "#facc15").strip() or "#facc15",
...
def get_public_menu_bootstrap(
    ...
    # primary_color / accent_color: prefer qr_menu_settings, fallback to customer_app_settings
    resolved_primary = str(qr_menu_settings.get("primary_color") or app_settings.get("primary_color") or "#facc15")
    resolved_accent = str(qr_menu_settings.get("accent_color") or app_settings.get("accent_color") or "#facc15")
    return {
        "tenant_id": tenant.id,
        ...
        "branding": {
            ...
            "background_color": str(qr_menu_settings.get("background_color") or "#0f0f0f"),
            "surface_color": str(qr_menu_settings.get("surface_color") or "#1a1a1a"),
            "text_color": str(qr_menu_settings.get("text_color") or "#ffffff"),
            ...
            "poster_background_color": str(qr_menu_settings.get("poster_background_color") or "#facc15"),
            ...
            "splash_type": str(qr_menu_settings.get("splash_type") or "none"),
            "splash_url": str(qr_menu_settings.get("splash_url") or ""),
            "splash_duration_ms": int(qr_menu_settings.get("splash_duration_ms") or 3000),
            "splash_overlay_text": str(qr_menu_settings.get("splash_overlay_text") or ""),
            "splash_bg_color": str(qr_menu_settings.get("splash_bg_color") or "#000000"),
