...
### 17.2. Planşet Olub-olmamasına Görə İş Axını

Obyektdə Bolt Food / Wolt planşetinin (tabletinin) olmasından asılı olaraq sifarişin qəbulu və idarə olunması iki üsulla baş verir:

* **Planşet Olduqda (Tablet Mode)**:
  1. Sifariş müştəri tərəfindən verildikdə ilk olaraq Bolt/Wolt fiziki planşetinə düşür və planşetin öz səs siqnalı çalınır.
  2. Kassir planşetdə sifarişi əl ilə təsdiqləyir (Accept edir). Beləliklə, sifarişin ilkin qəbulunu kassir (kassa operatoru) həyata keçirir.
  3. Kassir planşetdə sifarişi qəbul etdiyi an Bolt/Wolt bizim POS backend-imizə webhook sorğusu göndərir.
  4. Sifariş avtomatik olaraq daxili POS bazamıza qeyd olunur və KDS (Mətbəx ekranı) monitorunda avtomatik olaraq səs siqnalı (zəng səsi, "kitchen-bell.mp3") çalınır və cihaz vibrasiya edir. Bununla da mətbəx heyəti yeni sifarişin gəldiyini dərhal bilir. Addım 17.1-də qeyd olunan mətbəx axını başlayır.
  
* **Planşet Olmadıqda (Auto-Accept / Direct POS Integration Mode)**:
  1. Müştəri sifariş verdikdə platforma (Bolt/Wolt) sifarişi əlavə heyət müdaxiləsi olmadan avtomatik təsdiqləyir (Auto-Accept). Obyekt daxilində kassirin planşet üzərindən sifarişi qəbul etməsinə ehtiyac qalmır.
  2. Planşetə ehtiyac olmadan sifariş birbaşa bizim POS backend-imizə webhook vasitəsilə ötürülür və qeydiyyata alınır.
  3. Sifariş daxili POS backend-ə daxil olan saniyədə KDS (Mətbəx ekranı) monitorunda avtomatik olaraq səs siqnalı (zəng səsi, "kitchen-bell.mp3") çalınır və vibrasiya bildirişi göndərilir. Heç bir kassir və ya planşet müdaxiləsi olmadan zəng səsi çalınaraq mətbəx heyəti yeni sifariş barədə məlumatlandırılır.
  4. Mətbəx baristası/aşpazı KDS-də sifarişi "Qəbul et" düyməsinə klikləyərək hazırlayır.
  5. Sifariş tamamlandıqda sistem kassa ekranına pop-up bildiriş göndərir. Kassir sifariş qəbzindəki və ya ekrandakı sifariş ID-si vasitəsilə kuryer gəldikdə məhsulu təhvil verir.

### 17.3. İnteqrasiyanın Aktivləşdirilməsi
